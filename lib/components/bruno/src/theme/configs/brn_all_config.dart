...
import 'package:journal/components/bruno/src/theme/configs/brn_abnormal_state_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_action_sheet_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_appbar_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_button_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_card_title_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_common_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_dialog_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_enhance_number_card_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_form_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_gallery_detail_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_pair_info_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_picker_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_selection_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_tabbar_config.dart';
import 'package:journal/components/bruno/src/theme/configs/brn_tag_config.dart';
...
class BrnAllThemeConfig {
  ...
  void initThemeConfig(String configId) {
    _commonConfig ??= BrnCommonConfig();
    _appBarConfig ??= BrnAppBarConfig();
    _buttonConfig ??= BrnButtonConfig();
    _dialogConfig ??= BrnDialogConfig();
    _formItemConfig ??= BrnFormItemConfig();
    _cardTitleConfig ??= BrnCardTitleConfig();
    _abnormalStateConfig ??= BrnAbnormalStateConfig();
    _tagConfig ??= BrnTagConfig();
    _appBarConfig ??= BrnAppBarConfig();
    _pairInfoTableConfig ??= BrnPairInfoTableConfig();
    _pairRichInfoGridConfig ??= BrnPairRichInfoGridConfig();
    _actionSheetConfig ??= BrnActionSheetConfig();
    _pickerConfig ??= BrnPickerConfig();
    _enhanceNumberCardConfig ??= BrnEnhanceNumberCardConfig();
    _tabBarConfig ??= BrnTabBarConfig();
    _selectionConfig ??= BrnSelectionConfig();
    _galleryDetailConfig ??= BrnGalleryDetailConfig();
