import 'package:journal/components/bruno/src/components/charts/brn_progress_bar_chart/brn_progress_bar_chart_painter.dart';
...
class BrnProgressBarChartState extends State<BrnProgressBarChart> {
  ...
  void didUpdateWidget(BrnProgressBarChart oldWidget) {
    ...
    _clearSelectedBarItem(oldWidget);
  }
