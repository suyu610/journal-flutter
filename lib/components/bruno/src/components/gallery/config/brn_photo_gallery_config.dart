...
import 'package:journal/components/bruno/src/components/gallery/config/brn_bottom_card.dart';
import 'package:journal/components/bruno/src/components/loading/brn_loading.dart';
...
class BrnPhotoItemConfig extends BrnBasicItemConfig {
  ...
  BrnPhotoItemConfig({
    ...
    this.placeHolder = "assets/icons/grey_place_holder.png",
    this.onTap,
    this.onDoubleTap,
    this.onLongPress,
    this.name,
