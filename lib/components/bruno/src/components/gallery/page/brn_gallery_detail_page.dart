...
import 'package:journal/components/bruno/src/components/gallery/config/brn_basic_gallery_config.dart';
import 'package:journal/components/bruno/src/components/gallery/config/brn_controller.dart';
import 'package:journal/components/bruno/src/components/gallery/page/brn_gallery_summary_page.dart';
...
class BrnGalleryDetailPage extends StatefulWidget {
  ...
  BrnGalleryDetailPage(
      ...
      this.themeData})
      : super(key: key) {
    themeData ??= BrnGalleryDetailConfig();
