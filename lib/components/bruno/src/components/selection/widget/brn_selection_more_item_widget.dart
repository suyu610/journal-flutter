...
import 'package:journal/components/bruno/src/components/picker/base/brn_picker_title_config.dart';
import 'package:journal/components/bruno/src/components/picker/time_picker/brn_date_picker_constants.dart';
import 'package:journal/components/bruno/src/components/picker/time_picker/brn_date_time_formatter.dart';
import 'package:journal/components/bruno/src/components/picker/time_picker/date_picker/brn_date_picker.dart';
import 'package:journal/components/bruno/src/components/selection/bean/brn_selection_common_entity.dart';
import 'package:journal/components/bruno/src/components/selection/brn_more_selection.dart';
import 'package:journal/components/bruno/src/components/selection/brn_selection_util.dart';
import 'package:journal/components/bruno/src/components/selection/brn_selection_view.dart';
import 'package:journal/components/bruno/src/components/selection/widget/brn_layer_more_selection_page.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(padding: const EdgeInsets.only(top: 15), child: BrnLine())
      ],
    );
  }
